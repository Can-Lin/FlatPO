    ...
    if args.train_set_seed is not None or args.num_train_sets is not None:
        ...
        for train_set_id, train_samples in enumerate(train_sets):
            ...
            if args.trainer != "none":
                ...
                framework_after = Framework(args, task)
                #SGD
                learnt_model = '/data/zhuyifan/lc/ZO-LLM/zo-bench/result/regular-SST2-0-opt-1.3b-OPTIM_prefix-STEP500-sgd-LR0.1-cosine-ZOEPS0.001-Q1/model_state_dict_sgd.pth'
                #SAM
                #learnt_model = '/data/zhuyifan/lc/ZO-LLM/zo-bench/result/momenregular-SST2-0-opt-1.3b-OPTIM_prefix-STEP500-sgd-LR0.01-cosine-ZOEPS0.001-Q1/model_state_dict_sam.pth'
                #OURS
                #learnt_model = '/data/zhuyifan/lc/ZO-LLM/zo-bench/result/momenregular-SST2-0-opt-1.3b-OPTIM_prefix-STEP500-sgd-LR0.01-cosine-ZOEPS0.001-Q1/model_state_dict_our.pth'
                framework_after.model.load_state_dict(torch.load(learnt_model))
                ...
                # 3. 导出到 Excel
                df.to_excel("loss_landscape_sgd_prefix.xlsx", index=False)    
            logger.info(metrics)
            wandb.log(metrics)
